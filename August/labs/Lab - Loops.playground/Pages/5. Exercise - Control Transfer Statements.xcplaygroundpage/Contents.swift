...
let number = alphabet.enumerated()

for (index, letter) in number {
...
var cities = ["Utah": "Salt lake", "Alaska": "Juneau", "Califonia": "Sacramento"]
for (index, value) in cities {
    if index == "Utah" && value == "Salt lake" {
        print("I found my home!")
        break
    }
}
print(cities)
//is this right? I feel like it's not right because it only prints "i found my home!"
/*:
