...
let perimeter = width * 2 + height + height
print(perimeter)
...
even / 2
odd / 2
print("well as you can see i have 2 of the same answer but one really is even and one really is odd")
/*:
