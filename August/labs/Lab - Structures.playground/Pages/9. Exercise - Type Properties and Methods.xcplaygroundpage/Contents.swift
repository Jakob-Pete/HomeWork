...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "jak", email: "watermelon12@fruit.com", age: 6)
    static func logIn(user: User) {
        currentUser = user
        print("\(user.userName) is now logged in and online!")
 ...
 */
User.logIn(user: User(userName: "shawn", email: "pineapple16@fruit.com", age: 8))
