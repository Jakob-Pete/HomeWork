...
let favbook = Book(title: "how to make tacos", author: "someone who knows how to make tacos", pages: 56, price: 5.99)
print(favbook)
...
var lapTop = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2012)
lapTop = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2021)
print(lapTop)
/*:
