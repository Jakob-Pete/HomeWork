...
let newBest = 15_125
let congrats: String = "Congratulations, \(fullName)! you beat your last daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
print(congrats)
/*:
