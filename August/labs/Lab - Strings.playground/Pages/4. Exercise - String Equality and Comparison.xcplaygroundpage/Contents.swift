 ...
 */
let nameInCaps: String = "Jakob"
let name: String = "jakob"
if nameInCaps == name{
 ...
 */
if nameInCaps.lowercased() == "Jakob".lowercased(){
    print("\(nameInCaps.lowercased()) and \(name.lowercased()) are the same")
} else {print("\(nameInCaps.lowercased()) and \(name.lowercased()) are not the same")
              }
...
if junior.contains("Jr.") {
    print("We found a 2nd gen name!")
} else {print ("no 2nd gen name here..")
}
...
if textToSearchFor.contains("to be, or not to be") || textToSearchThrough.contains("To be, or not to be--that is the question") {
    print("I found it!")
} else {print("Nooooooo")
}
