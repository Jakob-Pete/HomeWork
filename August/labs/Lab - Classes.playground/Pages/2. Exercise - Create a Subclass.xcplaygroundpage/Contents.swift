...
let destoyer = Fighter()
destoyer.weapon = "boomstick"
destoyer.remainingFirePower = 10
destoyer.name = "Destoyer"
print(destoyer.position)
destoyer.moveRight()
print(destoyer.position)
...
//falcon.weapon = "a ruler"
//well theres no falcon in this class right now so thats my guess, but beyond that i'm not sure. I know theres something that has to do with inheriting but i can't remember.
...
destoyer.fire()
print(destoyer.remainingFirePower)
destoyer.fire()
print(destoyer.remainingFirePower)
destoyer.fire()
print(destoyer.remainingFirePower)
