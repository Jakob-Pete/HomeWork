...
class OrderTableViewController: UITableViewController {
    ...
    @IBSegueAction func confirmOrder(_ coder: NSCoder) -> OrderConfirmViewController? {
        return OrderConfirmViewController(coder: coder, minutesToPrepare: minutesToPrepareOrder)
    }
