...
print(userAge)
//it's nil because theres a letter in there so it can't be a Int. so the init is returning a nil
/*:
 ...
 */
print(userAge!)
//nothing really seems off. well without the unwrap its wack cuz it says optional
