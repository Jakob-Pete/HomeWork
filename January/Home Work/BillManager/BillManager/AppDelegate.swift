...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let remindAction = UNNotificationAction(identifier: remindActionID, title: "Pay your bills....you fetcher", options: [.authenticationRequired])
        
        let markAsPaidAction = UNNotificationAction(identifier: markAsPaidActionID, title: "Good job you faliure", options: [.authenticationRequired])
